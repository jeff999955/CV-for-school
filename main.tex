...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
      ...
      \iffalse
            Vancouver, BC, V3T \fi & GitHub: \href{https://github.com/jeff999955}{jeff999955} \\
\end{tabular*}
...
{Undergraduate Research Student}{Jun 2022 - Nov 2022}
...
\resumeSubheading
{Secure System Laboratory}{}{Undergraduate Research Student}{Sep, 2022 - present}
\resumeItemListStart
\resumeItem{Kernel Module Development}
% 這個經歷對於找 SWE 工作好像不是很有意義嗎（？）
{Research on implementing software support for role based memory access like CHERI hardware extension.}
\resumeItemListEnd
